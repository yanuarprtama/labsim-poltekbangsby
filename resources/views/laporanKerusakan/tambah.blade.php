...
<head>
  ...
  <title>LABSIMPOLTEKBANG | Tambah Laporan Kerusakan</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Lapora Kerusakan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="/lab">Laporan Kerusakan</a></li>
                        <li class="breadcrumb-item active">Tambah Laporan Kerusakan</li>
                    </ol>
                </div>
            </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="/prosestambahkerusakan" method="POST" enctype="multipart/form-data">
