...
<head>
  ...
  <title>LABSIMPOLTEKBANG | Konfirmasi Perawatan</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Konfirmasi Perawatan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="/perawatan">Daftar Perawatan</a></li>
                        <li class="breadcrumb-item active">Konfirmasi Perawatan</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Konfirmasi  Perawatan</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('konfirmasip',['id'=> $data['id']]) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    ...
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-warning{{$data['id']}}">Batal</button>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content bg-warning">
                        ...
                        <div class="modal-body">
                          <p>Anda yakin ingin membatalkan perawatan </b> ?&hellip;</p>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <form action="{{ route('batalperawatan',['id'=> $data['id']]) }}" method="POST">
                                @csrf
