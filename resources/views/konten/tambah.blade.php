...
<head>
  ...
  <title>LABSIMPOLTEKBANG | Tambah slider</title>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="/prosestambahslider" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="posisi" class="form-control" id="posisi" placeholder="posisi">
                      </div>
                      <div class="form-group">
