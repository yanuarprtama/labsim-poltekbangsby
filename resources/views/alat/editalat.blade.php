...
<head>
  ...
  <title>LABSIMPOLTEKBANG | Edit Alat</title>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('updatealat',['id'=> $data['id']]) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="stok" class="form-control" id="stok" placeholder="stok" value="{{$data['stok']}}">
                      </div>
                      <div class="form-group">
