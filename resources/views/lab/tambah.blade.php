...
<head>
  ...
  <title>LABSIMPOLTEKBANG | Tambah Lab</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Data Laboratorium & Simulator</h1>
                </div>
                <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="/prosestambahlab" method="POST" enctype="multipart/form-data">
                  @if($errors->any())
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="virtualtour_url" class="form-control" id="virtualtour" placeholder="Virtualtour">
                      </div>
                      <div class="form-group">
