...
<head>
    ...
    <title>LABSIMPOLTEKBANG | Detail Lab</title>
...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="#">Daftar Lab</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <a href="/lab" class="btn btn-primary"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <img src="../assets/img/lab/{{$data['gambar']}}" style="width: 700px; height: 500px;" alt="Gambar">
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <th>virtualtour_url</th>
                                    <td>{{$data['virtualtour_url']}}</td>
                                </tr>
                                <tr>
                                    <th>prodi</th>
                                    <td>{{$data['prodi']}}</td>
